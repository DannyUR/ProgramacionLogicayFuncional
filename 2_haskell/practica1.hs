--1. Obtiene el valor absoluto de un numero
absoluto:: Integer -> Integer
absoluto x = abs x

--2. Obtiene el menor entero no menor que x
menorEntero :: Double -> Integer
menorEntero x = ceiling x

--3. Devuelve el valor siguiente de x
siguiente :: Integer -> Integer
siguiente x = succ x

--4. Obtiene el menor entre dos números
minimo :: Integer -> Integer -> Integer
minimo x y = min x y

--5. Obtiene el mayor entre dos números
...
--7. Obtiene el módulo de x y y
modulo :: Integer -> Integer -> Integer
modulo x y = mod x y

--8. Verifica si x es par
esPar :: Integer -> Bool
esPar x = even x

--9. Obtiene el mayor entero no mayor que x
mayorEntero :: Double -> Integer
mayorEntero x = floor x

--10. Obtiene el máximo común divisor
maximoComunDivisor :: Integer -> Integer -> Integer
maximoComunDivisor x y = gcd x y

--11. Negación de booleana
negacion :: Bool -> Bool
negacion x = not x

--12. Verifica si un número es impar
esImpar :: Integer -> Bool
esImpar x = odd x

--13. Devuelve 1 si es positivo, -1 si es negativo, 0 si es cero
signo :: Integer -> Integer
signo x = signum x

--14. Retorna el segundo elemento de una tupla
